<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="XIT.UDMP.Web.Index" %>
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="index.aspx"><span class="fa fa-area-chart"></span> UDMP<span class="dashboard_text">高校数字化管理平台</span></a></h1>
          </div>
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                ...
                <i class="fa fa-dashboard"></i> <span>学生管理</span> <i class="fa fa-angle-left pull-right"></i>
                  ...
                  <li><a href="general.html"><i class="fa fa-angle-right"></i> 在线评教</a></li>
                  <li><a href="icons.html"><i class="fa fa-angle-right"></i> 线上请假</a></li>
                  <li><a href="buttons.html"><i class="fa fa-angle-right"></i> 网上缴费</a></li>
                  <li><a href="typography.html"><i class="fa fa-angle-right"></i> 查看成绩</a></li>
                </ul>
              </li>
			  <li class="treeview">
                <a href="#">
                ...
                <ul class="treeview-menu">
                  <li><a href="grids.html"><i class="fa fa-angle-right"></i> 班级课程</a></li>
                  <li><a href="media.html"><i class="fa fa-angle-right"></i> 学生成绩</a></li>
                  <li><a href="media.html"><i class="fa fa-angle-right"></i>在线请假</a></li>
                  <li><a href="media.html"><i class="fa fa-angle-right"></i>其他老师任课</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="charts.html">
                <i class="fa fa-pie-chart"></i>
                <span>班主任管理</span>  <i class="fa fa-angle-left pull-right"></i>
                <%--<span class="label label-primary pull-right">new</span>--%>
                </a>
                  <ul class="treeview-menu">
                  <li><a href="general.html"><i class="fa fa-angle-right"></i> 学生分班</a></li>
                  <li><a href="icons.html"><i class="fa fa-angle-right"></i查询老师</a></li>
                  <li><a href="buttons.html"><i class="fa fa-angle-right"></i>学生请假信息</a></li>
                  <li><a href="typography.html"><i class="fa fa-angle-right"></i>班级信息</a></li>
                  <li><a href="typography.html"><i class="fa fa-angle-right"></i>上课时间</a></li>
                </ul>
              </li>
              <li class="treeview">
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="general.html"><i class="fa fa-angle-right"></i> 基本信息</a></li>
                  <li><a href="icons.html"><i class="fa fa-angle-right"></i> 查询条件</a></li>
                </ul>
              </li>
			  <li>
                <a href="widgets.html">
                <i class="fa fa-th"></i> <span>班级管理</span> <i class="fa fa-angle-left pull-right"></i>
                <%--<small class="label pull-right label-info">08</small>--%>
                </a>
                   <ul class="treeview-menu">
                  <li><a href="general.html"><i class="fa fa-angle-right"></i> 基本信息</a></li>
                  <li><a href="icons.html"><i class="fa fa-angle-right"></i> 列表信息</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="#">
                <i class="fa fa-edit"></i> <span>教务管理</span>
                <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                  <li><a href="forms.html"><i class="fa fa-angle-right"></i> 学科分组</a></li>
                  <li><a href="validation.html"><i class="fa fa-angle-right"></i> 部门分组</a></li>
                  <li><a href="validation.html"><i class="fa fa-angle-right"></i> 在线调课</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="#">
                ...
                <ul class="treeview-menu">
                  <li><a href="tables.html"><i class="fa fa-angle-right"></i> 财务报表</a></li>
                  <li><a href="tables.html"><i class="fa fa-angle-right"></i> 教职工工资</a></li>
                  <li><a href="tables.html"><i class="fa fa-angle-right"></i> 缴费信息</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="#">
                <i class="fa fa-envelope"></i> <span>统计管理 </span>
                ...
                <ul class="treeview-menu">
                  <li><a href="inbox.html"><i class="fa fa-angle-right"></i> 学生成绩汇总 </a></li>
                  <li><a href="compose.html"><i class="fa fa-angle-right"></i> 老师成绩汇总 </a></li>
                  <li><a href="compose.html"><i class="fa fa-angle-right"></i> 退学/休学汇总 </a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="#">
                ...
                <ul class="treeview-menu">
                  <li><a href="login.aspx"><i class="fa fa-angle-right"></i> 登陆</a></li>
			...
			<div class="col-md-4 span_8">
				<div class="activity_box">
					...
					<form action="#" method="post" runat="server">
                        <asp:TextBox ID="TextBox1"  value="Enter your text" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter your text';}" required="" runat="server"></asp:TextBox>
						<%--<input type="text" value="Enter your text" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter your text';}" required="">--%>
                        <asp:Button ID="Button1" runat="server" Text="Button" value="Submit"/>
