<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="general.aspx.cs" Inherits="XIT.UDMP.Web.general" %>
...
<body class="cbp-spmenu-push">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
            ...
            <ul class="sidebar-menu">
			  ...
			  <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="grids.aspx"><i class="fa fa-angle-right"></i> Grids</a></li>
                  <li><a href="media.aspx"><i class="fa fa-angle-right"></i> Media Css</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="charts.aspx">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="general.aspx"><i class="fa fa-angle-right"></i> General</a></li>
                  <li><a href="icons.aspx"><i class="fa fa-angle-right"></i> Icons</a></li>
                  <li><a href="buttons.aspx"><i class="fa fa-angle-right"></i> Buttons</a></li>
                  <li><a href="typography.aspx"><i class="fa fa-angle-right"></i> Typography</a></li>
                </ul>
              </li>
			  <li>
                <a href="widgets.aspx">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="forms.aspx"><i class="fa fa-angle-right"></i> General Forms</a></li>
                  <li><a href="validation.aspx"><i class="fa fa-angle-right"></i> Form Validations</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="#">
                ...
                <ul class="treeview-menu">
                  <li><a href="tables.aspx"><i class="fa fa-angle-right"></i> Simple tables</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="#">
                ...
                <ul class="treeview-menu">
                  <li><a href="inbox.aspx"><i class="fa fa-angle-right"></i> Mail Inbox</a></li>
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  ...
                  <li><a href="signup.aspx"><i class="fa fa-angle-right"></i> Register</a></li>
                  <li><a href="404.aspx"><i class="fa fa-angle-right"></i> 404 Error</a></li>
                  <li><a href="500.aspx"><i class="fa fa-angle-right"></i> 500 Error</a></li>
                  <li><a href="blank-page.aspx"><i class="fa fa-angle-right"></i> Blank Page</a></li>
                </ul>
              </li>
		...
		<!--footer-->
		<div class="footer">
		   <p>Copyright &copy; 2018.Company name All rights reserved.More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></p>		</div>
        <!--//footer-->
	</div>
