<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forms.aspx.cs" Inherits="XIT.UDMP.Web.forms" %>
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.aspx"><span class="fa fa-area-chart"></span> UDMP<span class="dashboard_text">高校数字化管理平台</span></a>
          </div>
